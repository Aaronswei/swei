...
namespace UserInterface
{
    ...
    private:
        ...
        void (Menu::*runHandler[AMOUNT_HANDLERS])() =
        {
            ...
            &Menu::setPauseBetweenReqs, &Menu::setUserAgent, &Menu::setMaxDepth, &Menu::switchInfiniteMode,
            &Menu::switchSearchInSE, &Menu::selectSearchEngine, &Menu::displayPhrasesForSearch, &Menu::addPhraseForSearch
        };
